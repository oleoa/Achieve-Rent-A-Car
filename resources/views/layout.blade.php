  ...
  <head>
    ...
    <body class="min-h-screen flex flex-col justify-between">
        ...
        <div class="flex xl:hidden h-navbar relative w-full justify-center items-center bg-white">
          ...
          <nav id="sidebar" class="bg-zinc-800 text-white h-screen w-44 fixed top-0 left-0 transition-transform duration-300 transform -translate-x-full">
            ...
            <div class="flex justify-between pr-4">
              <a class="loaderActivator @if($current == 'home') text-blue-400 underline @endif" href="{{route('home', $locale)}}"><h4 class="p-4">@lang('Home')</h4></a>
            ...
            <a class="loaderActivator @if($current == 'about') text-blue-400 underline @endif" href="{{route('about', $locale)}}"><h4 class="p-4">@lang('About')</h4></a>
            <a class="loaderActivator @if($current == 'faq') text-blue-400 underline @endif" href="{{route('faq', $locale)}}"><h4 class="p-4">@lang('FAQ')</h4></a>
            <a class="loaderActivator @if($current == 'contact') text-blue-400 underline @endif" href="{{route('contact', $locale)}}"><h4 class="p-4">@lang('Contact')</h4></a>
      ...
      <div role="status" id="loading" class="hidden h-screen w-screen bg-zinc-200/70 z-50 fixed top-0 left-0 items-center justify-center">
        ...
        -->
        <img src="{{url('/img/loader.png')}}" alt="Loader" class="animate-spin-slow absolute z-30 w-28">
        <img src="{{url('/img/logo_sem_carro.png')}}" alt="Loader" class="absolute z-20 h-14">
      </div>
