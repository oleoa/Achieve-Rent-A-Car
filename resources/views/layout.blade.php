  ...
  <head>
    ...
    <body class="min-h-screen flex flex-col justify-between">
      ...
      <div role="status" id="loading" class="hidden h-screen w-screen bg-zinc-200/70 z-50 fixed top-0 left-0 items-center justify-center">
        <svg aria-hidden="true" class="w-16 text-gray-200 animate-spin dark:text-flagBlue fill-flagYellow" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Whatsapp button -->
      <a href="https://wa.me/351" target="_blank" class="fixed bottom-16 right-5 z-50 bg-[#25D366] h-16 w-16 rounded-3xl flex items-center justify-end xl:[&>p]:hover:flex hover:flex xl:hover:w-whatsapp_expanded">
        <p class="hidden text-start w-whatsapp_text p-4 text-white">Sinta-se à vontade para entrar em contato conosco ou usar o botão do WhatsApp se tiver alguma outra pergunta.</p>
