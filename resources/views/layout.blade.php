...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <head>
    ...
    <body class="min-h-screen flex flex-col justify-between">
      ...
      <!-- Whatsapp button -->
      <a href="https://wa.me/351" target="_blank" class="fixed bottom-16 right-5 z-50 bg-[#25D366] h-16 w-16 rounded-3xl flex items-center justify-end [&>p]:hover:flex hover:flex hover:w-whatsapp_expanded">
