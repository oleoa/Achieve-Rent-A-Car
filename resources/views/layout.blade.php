  ...
  <head>
    ...
    <body class="min-h-screen flex flex-col justify-between">
        ...
        <nav class="h-navbar px-margin bg-white w-full hidden xl:flex justify-between items-center">
          ...
          <div class="flex items-center justify-center gap-6">
            ...
            <div class="flex justify-center items-center gap-4">
              <a title="Click to change the language to english" href="{{route($current, ['en'])}}" class="loaderActivator">
                <img src="{{ asset('img/flags/en.png') }}" alt="English Flag" class="w-6 h-4">
              </a>
              <a title="Click to change the language to portuguese" href="{{route($current, ['pt'])}}" class="loaderActivator">
      ...
      <div class="fixed bottom-16 right-5 z-40 flex flex-col items-end">
        ...
        <a title="Click here to speak with one of us" href="https://wa.me/351" target="_blank" class="bg-[#25D366] h-16 w-16 rounded-3xl flex items-center justify-end xl:[&>p]:hover:flex hover:flex xl:hover:w-whatsapp_expanded">
      ...
      <footer class="w-full xl:px-margin px-4 bg-flagBlue min-h-footer flex flex-col justify-center items-start gap-4 py-4">
        ...
        <div class="flex gap-4 text-white justify-center items-center">
          ...
          <!-- Instagram -->
          <a title="Click here to visit us on Instagram" href="https://www.instagram.com/achieverentacar/" target="_blank">
          ...
          <!-- Youtube -->
          <a title="Click here to visit us on Youtube" href="https://www.instagram.com/achieverentacar/" target="_blank">
          ...
          <!-- Facebook -->
          <a title="Click here to visit us on Facebook" href="https://www.instagram.com/achieverentacar/" target="_blank">
