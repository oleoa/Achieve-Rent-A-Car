...
@section('main')
  ...
  <article class="px-default py-4">
    ...
    <section class="shadow-2xl flex gap-4 p-4 rounded-md">
      <div class="flex flex-col gap-4 min-w-max">
        <h2 class="font-bold">@lang('stays.ap.1.title')</h2>
        <h3>@lang('stays.ap.1.description')</h3>
        <p class="flex items-center gap-2 px-4 py-2 bg-flagYellow rounded-md">
      ...
      <div class="grid grid-cols-4 grid-rows-2 gap-4">
        <img class="object-cover h-full rounded-md col-span-2 row-span-2" src="https://a0.muscache.com/im/pictures/miso/Hosting-49396733/original/f2c1c289-d3f9-4189-a721-7ae5525d891e.jpeg?im_w=960" alt="Image of the stay">
        <img class="object-cover h-full rounded-md" src="https://a0.muscache.com/im/pictures/miso/Hosting-49396733/original/c6ca3076-ba8d-49d5-b11c-3d9f08567c9d.jpeg?im_w=720" alt="Image of the stay">
        <img class="object-cover h-full rounded-md" src="https://a0.muscache.com/im/pictures/a5e1b1f0-ce51-4889-9981-4663393e91af.jpg?im_w=720" alt="Image of the stay">
        <img class="object-cover h-full rounded-md" src="https://a0.muscache.com/im/pictures/e3ab714a-a6e0-41c6-8c2b-5b0843be9292.jpg?im_w=720" alt="Image of the stay">
        <img class="object-cover h-full rounded-md" src="https://a0.muscache.com/im/pictures/fe8493e6-cef5-46af-854b-145efe6880fc.jpg?im_w=720" alt="Image of the stay">
      </div>
    </section>
