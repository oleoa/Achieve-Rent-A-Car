      ...
      @for($i = 1; $i <= 2; $i++)
        ...
        <div class="rounded-lg flex flex-col items-center md:w-96 text-center">
          ...
          <div class="p-4 flex flex-col gap-4">
            ...
            <a class="px-4 py-2 transition-all duration-300 rounded-md border-2 border-red bg-red text-white hover:bg-white hover:text-red" target="_blank" href="{{asset('/files/'.$i.'.pdf')}}">
