  ...
  <main class="min-h-screen">
    ...
    <div class="py-8 flex flex-col gap-8">
        ...
        <div class="w-full xl:px-margin px-4 grid xl:grid-cols-2 grid-cols-1 gap-4">
          <div class="flex flex-col xl:items-start items-center justify-center gap-4 xl:order-1 order-2">
            <h2 class="text-center xl:text-start py-0 xl:text-4xl text-xl">@lang('Seats-Section.1-Title')</h2>
            <p class="text-center xl:text-start">@lang('Seats-Section.1-Paragraph')</p>
          </div>
    ...
    <div class="py-8 flex flex-col gap-8">
        ...
        <div class="grid xl:grid-cols-4 w-full xl:px-margin px-4 gap-4">
            ...
            <h2 class="xl:col-span-4 py-4 text-center font-bold text-4xl">@lang('Seats-Section.Cards-Title')</h2>
    
            @for($i = 1; $i <= 4; $i++)
                <div class="rounded-lg shadow-lg">
                    <img src="{{asset('/img/tests/'.$i.'.png')}}" alt="Madeira Island Image" class="rounded-t-lg">
                    <div class="p-4">
                        <h3 class="text-2xl font-bold text-gray-800">@lang('Seats-Section.Cards-Card.'.$i.'-Title')</h3>
                        <p class="mt-2 text-gray-600">
                            @lang('Seats-Section.Cards-Card.'.$i.'-Paragraph')
                        </p>
                    </div>
                </div>
            @endfor
