...
@section('main')
  ...
  <div class="relative z-10 w-full overflow-x-hidden xl:hidden">
    ...
    <!-- Carousel Buttons -->
    <div class="absolute top-0 w-full h-full hidden justify-between xl:items-center items-end xl:z-auto z-50" id="carousel-buttons-div-reviews-mobile">
    ...
    <!-- Carousel Indicator -->
    <div class="absolute bottom-0 w-full hidden justify-center items-center gap-2 p-4 xl:z-auto z-40" id="carousel-indicators-div-reviews-mobile">
