<div role="status" id="loading" class="hidden h-screen w-screen  {{$isLight?'bg-zinc-200/70':'bg-neutral-900/70'}} z-50 fixed top-0 left-0 items-center justify-center">
