<nav class="w-full h-20 bg-white/50 backdrop-blur items-center gap-4 px-default hidden laptop:flex">
    ...
    <div class="flex justify-start">
        ...
        <a title="@lang('menu.en.title')" href="{{route($current, ['locale' => 'en'])}}" class="flex gap-2 items-center laptop:bg-transparent bg-white p-2 rounded-l-md">
            <img src="{{asset('/img/flags/en.jpg')}}" alt="England Flag" height="24" width="32" class="object-cover rounded">
        </a>
    
        <a title="@lang('menu.pt.title')" href="{{route($current, ['locale' => 'pt'])}}" class="flex gap-2 items-center laptop:bg-transparent bg-white p-2 rounded-r-md">
