<div id="headerContent" @class([
    ...
    <img src="{{asset('/img/navbar/phone.webp')}}" alt="Achieve Rent a Car Log" height="48" width="213" class="block lg:hidden max-h-12 lg:px-0 px-14 object-cover">
    <img src="{{asset('/img/navbar/computer.webp')}}" alt="Achieve Rent a Car Log" height="48" width="306" class="hidden lg:block max-h-12 lg:px-0 px-14 object-cover">
