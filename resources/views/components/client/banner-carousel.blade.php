...
<div class="relative z-10 w-full overflow-x-hidden xl:h-homeTitleXL h-homeTitle">
  ...
  <div id="carousel-slide-banner" class="rounded grid transition-transform duration-500 xl:h-homeTitleXL h-homeTitle w-full" style="grid-template-columns: @for($i = 1; $i <= 1; $i++) 100% @endfor">
    ...
    <!-- Carousel Item 1 -->
    <div class="w-full xl:h-homeTitleXL h-homeTitle relative bg-cover bg-center grid grid-cols-2 content-center xl:px-margin px-4" style="background-image: url(/img/home/banner.jpg)">

      <h1 itemprop="https://schema.org/name" class="text-flagRed p-4 rounded-xl bg-white/75 font-black xl:text-4xl text-lg h-fit w-fit">
