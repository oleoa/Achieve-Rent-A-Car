<div class="fixed bottom-16 right-5 z-40 flex flex-col items-end">
    ...
    <a title="Click here to speak with one of us" href="https://wa.me/351968178109" target="_blank" class="bg-[#25D366] h-16 w-16 rounded-3xl flex items-center justify-end xl:[&>p]:hover:flex hover:flex xl:hover:w-whatsapp_expanded">
