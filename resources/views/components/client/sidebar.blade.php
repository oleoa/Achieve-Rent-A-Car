<div class="flex xl:hidden h-navbar relative w-full justify-center items-center bg-white">
    ...
    <!-- Logo -->
    <a title="@lang('Menu-Home.Title')" href="{{$menu['links']['home']['route']}}"><img src="{{url('/img/logos/logo2.png')}}" alt="@lang('Menu-Logo.Alt')" class="h-10 pl-6"></a>
    ...
    <aside class="h-screen w-screen fixed top-0 left-0 transition-transform duration-300 transform -translate-x-full flex flex-row">
        ...
        <div class="w-96 bg-white h-full z-40">
            ...
            <div class="flex justify-between pr-4">
                <a title="@lang('Menu-Home.Title')" class="@if($menu['links']['home']['current']) text-blue-400 underline @endif" href="{{$menu['links']['home']['route']}}"><h4 class="p-4">@lang('Menu-Home')</h4></a>
            ...
            @foreach ($menu['links'] as $item)
                ...
                <!-- Item -->
                <a title="@lang('Menu-'.$item['name'].'.Title')" class="@if($item['current']) text-blue-400 underline @endif" href="{{$item['route']}}"><h4 class="p-4">@lang('Menu-'.$item['name'])</h4></a>
