  ...
  <main>
    ...
    <div class="xl:px-margin xl:grid xl:grid-cols-3 px-4 py-8">
      ...
      <div class="flex flex-col gap-4 col-span-1 pb-4">
        <div class="xl:px-0">
          <div class="flex items-center">
            <h3 class="font-bold">@lang('Whatsapp')</h3>
        ...
        <div class="xl:px-0">
          ...
          <a href="mailto:info@achieverentacar.com" class="text-flagBlue underline"><h3>info@achieverentacar.com</h3></a>
        </div>
      </div>
      ...
      <form action="{{route('contact-send')}}" method="POST" class="flex flex-col space-y-4 col-span-2 xl:p-0 pb-4">
        ...
        <input class="shadow-lg px-4 py-2 bg-zinc-200 rounded-md hover:bg-zinc-10 hover:shadow-xl loaderActivator" type="submit" value="@lang('Send')">
        @if(session('success'))
