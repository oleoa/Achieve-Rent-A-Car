  ...
  <main>
    ...
    <div class="xl:px-margin xl:grid xl:grid-cols-3 px-4 py-8">
      ...
      <form action="{{route('contact-send', $locale)}}" method="POST" class="flex flex-col space-y-4 col-span-2 xl:p-0 pb-4">
        ...
        <input class="shadow-lg px-4 py-2 bg-zinc-200 rounded-md hover:bg-zinc-10 hover:cursor-pointer hover:shadow-xl loaderActivator" type="submit" value="@lang('Contact.Us-Form-Button')">
        @if(session('success'))
