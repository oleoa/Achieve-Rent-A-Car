  ...
  <article class="grid laptop:grid-cols-3 tablet:grid-cols-2 px-default gap-12 py-4">
    ...
    @foreach ($fleet as $vehicle)
      ...
      <div class="flex flex-col p-4 gap-2">
        ...
        <div class="flex">
          <span class="flex gap-2 items-center justify-center pr-2"><i class="fa-solid fa-door-open"></i>{{$vehicle['infos']['doors']}}<span>|</span></span>
          <span class="flex gap-2 items-center justify-center pr-2"><i class="fa-solid fa-gears"></i>{{$vehicle['infos']['cluth']}}<span>|</span></span>
          <span class="flex gap-2 items-center justify-center pr-2"><i class="fa-solid fa-car-on"></i>{{$vehicle['infos']['cc']}}<span>|</span></span>
        ...
        <div class="flex">
          ...
          <span class="flex gap-2 items-center justify-center pr-2"><i class="fa-solid fa-gears"></i>{{$vehicle['infos']['steering']}}</span>
        </div>
