...
return [
  ...
  '4' => '4 - The minimum rental period to be charged is one day (24H). <br> In cases of delays of more than 1 hour in returning the car without the Lessor being notified in advance, the Lessee may be charged for an extra day\'s rental. Pick-ups and returns that occur between 09:01 P.M. and 07:59 A.M. will be subject to out-of-hours service fees of €20 each. <br> If the Lessee wishes to change the pick-up time or the time for returning the vehicle, he must contact the Lessor at least 4 hours in advance of the desired time or the time stated in the contract, whichever is shorter. If the request is made less than 4 hours in advance, it may not be answered. <br> Delay in picking up the vehicle for reasons beyond the control of the Lessor will not result in a discount on the contract value. Premature delivery of the vehicle will not result in refunds.',
  ...
  '9.8' => 'Filling up with the wrong fuel - fee of €700.',
  '9.9' => 'Damage to the engine/gearbox/clutch - the values will be calculated according to the damage and affected parts.',
  '9.10' => 'Damage to the interior of the vehicle - the values will be calculated according to the damage and affected parts.',
  '9.11' => 'Windows, headlights, taillights, mirrors, locks, rims and tires - will have their values calculated according to the damage and affected parts.',
  '9.11.1' => 'The Lessee may choose to take out the Additional Insurance, with coverage for windows, mirrors, headlights, taillights, locks, rims and tires, for a value of €5 per day.',
