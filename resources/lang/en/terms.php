...
return [
  ...
  '4' => '4 - The minimum rental period to be charged is one day (24H). In cases of delays of more than 1 hour in returning the car without the Lessor being notified in advance, the Lessee may be charged for an extra day\'s rental. Any and all pick-ups and drop-offs made in the period between 10:01 pm and 6:59 am will be subject to the out-of-hours service fee, worth €40 each, even if it was not originally selected. If the Lessee wishes to change the pick-up time or the time for returning the vehicle, he must contact the Lessor at least 4 hours in advance of the desired time or the time stated in the contract, whichever is shorter. If the request is made less than 4 hours in advance, it may not be answered. Delay in picking up the vehicle for reasons beyond the control of the Lessor will not result in a discount on the contract value. Premature delivery of the vehicle will not result in refunds.',
