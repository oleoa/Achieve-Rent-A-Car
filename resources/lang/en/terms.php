...
return [
  ...
  '1.2' => 'Is aware that the vehicle must only be driven by the Lessee and/or only by additional drivers who are obligatorily included in this agreement.',
  ...
  '2.title' => '2 - The Lessee declares to have received the vehicle with:',
  '2.1' => '1 vehicle key.',
  ...
  '4' => '4 - The minimum rental period to be charged is one day (24H). In cases of delays of more than 1 hour in returning the car without the Lessor being notified in advance, the Lessee may be charged for an extra day\'s rental. Any and all pick-ups and drop-offs made in the period between 11:01 PM and 7:59 AM will be subject to the out-of-hours service fee, worth €30 each, even if it was not originally selected. If the Lessee wishes to change the pick-up time or the time for returning the vehicle, he must contact the Lessor at least 4 hours in advance of the desired time or the time stated in the contract, whichever is shorter. If the request is made less than 4 hours in advance, it may not be answered. If the new time falls within the out-of-hours period, the current fee will be increased. Delay in picking up the vehicle for reasons beyond the control of the Lessor will not result in a discount on the contract value. Premature delivery of the vehicle will not result in refunds.',
  ...
  '7' => '7 - Prices include: VAT, Premium insurance with no excess (SCDW), maintenance and 24-hour roadside assistance.',  
  '8' => '8 - Prices do not include: Parking, fuel, washing and fines expenses.',  
  '9.title' => '9 - Premium Insurance (SCDW) covers:',
  ...
  '9.7' => 'Strikes, riots, civil commotions, vandalism, acts of terrorism.',
  ...
  '9.8' => 'Damages to windows, mirrors, headlights, taillights, locks, rims and tires, unless the damage results from a shock, collision or rollover and is accompanied by other damage to the vehicle. <b>The Lessee may choose to take out the "Additional Insurance" and guarantee coverage for windows, mirrors, headlights, taillights, locks, rims and tires, for a value of €5 per day.</b>',
  ...
  '9.12' => 'Intentional damage caused by the Lessee or people under his responsibility to the vehicle or third parties - will have the values calculated according to the damage and affected parts.',
  '9.13' => 'Damage caused by a person driving without legal authorization and/or without authorization from the Lessor; under the influence of alcohol, drugs or by a person suffering from mental insanity - the values will be calculated according to the damage and affected parts.',
  '9.14' => 'Damages for participation in sporting events, rallies, challenges, contests, competitions - the values will be calculated according to the damage and affected parts.',
  '9.15' => 'Damage due to negligent driving, incompetence or misuse of the vehicle - the values will be calculated according to the damage and affected parts.',
  '9.16' => 'Damages for driving in a manner that disregards local traffic laws and rules and or in a manner that disregards warnings from authorities and traffic, danger or risk signs, for driving, being stopped or parked in prohibited places, for driving, being stopped or parked in places closed by authorities - the values will be calculated according to the damage and affected parts.',
  '9.17' => 'Damage from use to push or tow any vehicle, trailer or any other object - the values will be calculated according to the damage and affected parts.',
  '9.18' => 'Damage occurred to:',
  '9.18.1' => 'Transport of passengers or goods in exchange for any compensation, explicit or implicit.',
  '9.18.2' => 'For the transport of passengers and/or goods in violation of what, by the way, is provided for in the characteristics of the vehicle.',
  '9.18.3' => 'For the transport of prohibited or illegal goods, or in violation of customs regulation.',
  '9.19' => 'Damage due to accidents that are not reported to the Lessor and the police- the values will be calculated according to the damage and affected parts.',
  '9.20' => 'Damage or loss of Renter\'s belongings left in the vehicle.',
  ...
  '12' => '12 - The Lessee is responsible for maintaining the vehicle and its equipment throughout the rental period, and must check the oil, fuel, water and tire pressure levels. He must keep the vehicle properly closed and locked outside of use and not leave objects that could be stolen or damaged in the vehicle. Smoking is not permitted inside the vehicle, subject to a fine of 100€. The exchange of parts or any components and/or accessories of the vehicle is not permitted. Subletting of the rented vehicle is not permitted. Repairs or interventions on the vehicle may only be carried out by companies contracted by the Lessor. In case of excessive dirt, beyond what is expected for normal use of the vehicle (interior and/or exterior), a cleaning fee of €15 will be applied.',
